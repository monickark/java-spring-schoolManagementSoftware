...
public class PrevYearFeeUpdateDecorator extends TableDecorator {
	...
	public String getEditbox() {
		...
		PrevYearFeeUpdateListVO PrevYearFeeUpdateListVO = (PrevYearFeeUpdateListVO) getCurrentRowObject();
		StringBuffer buffer = new StringBuffer();
		
				buffer.append("<input type=\"text\" name=\"textbox\" value=\"");
				buffer.append(PrevYearFeeUpdateListVO.getLastYearAmt());
				buffer.append("\"");
				buffer.append("/>");
		
				buffer.append("<input type=\"hidden\" name=\"rowids\" value=\"");
				buffer.append(PrevYearFeeUpdateListVO.getRowid());
				buffer.append("\"");
				buffer.append("/>");
	...
	public String getCheckbox() {
		...
		buffer.append("<input type='hidden' name='rowid' value='"
				+ PrevYearFeeUpdateListVO.getRowid() + "'/>");
		return buffer.toString();
	}
