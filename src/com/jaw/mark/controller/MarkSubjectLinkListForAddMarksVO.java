...
public class MarkSubjectLinkListForAddMarksVO implements Serializable {
	// Logging
	Logger logger = Logger.getLogger(MarkSubjectLinkListForAddMarksVO.class);
	...
	public String toString() {
		return "MarkSubjectLinkListForAddMarksVO [mkslId=" + mkslId
				+ ", examType=" + examType + ", subTestId=" + subTestId
				+ ", crslId=" + crslId + ", labBatch=" + labBatch
				+ ", examDate=" + examDate + ", minMark=" + minMark
				+ ", maxMark=" + maxMark + ", remarks=" + remarks
				+ ", subPortionDetails=" + subPortionDetails + ", markGrade="
				+ markGrade + ", rowid=" + rowid + ", status=" + status
				+ ", examId=" + examId + ", subject=" + subject
