...
public class StudentReportCardVO implements Serializable {
	// Logging
	Logger logger = Logger.getLogger(StudentReportCardVO.class);
	...
	public String toString() {
		return "StudentReportCard [logger=" + logger + ", acTerm=" + acTerm
				...
				+ ", maxMarkObt=" + maxMarkObt + ", attendance=" + attendance
				+ ", subId=" + subId + ", examOrder=" + examOrder
				+ ", subName=" + subName + "]";
	}
