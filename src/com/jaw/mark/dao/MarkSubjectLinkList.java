...
public class MarkSubjectLinkList implements Serializable {
	// Logging
	Logger logger = Logger.getLogger(MarkSubjectLinkList.class);
	...
	public String toString() {
		return "MarkSubjectLinkList [logger=" + logger + ", MarkSubjectLinkId="
				+ MarkSubjectLinkId + ", acTerm=" + acTerm + ", studentGrpId="
				+ studentGrpId + ", examId=" + examId + ", examType="
				+ examType + ", subTestId=" + subTestId + ", crslId=" + crslId
				+ ", labBatch=" + labBatch + ", examDate=" + examDate
				+ ", minMark=" + minMark + ", maxMark=" + maxMark
				+ ", subType=" + subType + ", subId=" + subId + ", subName="
				+ subName + ", requiresLab=" + requiresLab + ", markOrGrade="
